...
const DEMO_VENDOR_PROFILES = [
  { userId: "demo_vend_1", storeName: "Biryani House AJK",       storeCategory: "restaurant",  storeDescription: "Best biryani in Muzaffarabad since 2010",           storeHours: "10:00-23:00", storeMinOrder: "200",  storeDeliveryTime: "25-40 min", storeAddress: "Upper Adda, Muzaffarabad", businessType: "restaurant", businessName: "Biryani House" },
  { userId: "demo_vend_2", storeName: "AJK Mart Store",          storeCategory: "grocery",     storeDescription: "Daily groceries, dairy, meat and household items",   storeHours: "08:00-22:00", storeMinOrder: "100",  storeDeliveryTime: "20-35 min", storeAddress: "CMH Road, Muzaffarabad",   businessType: "grocery",    businessName: "AJK Mart" },
  { userId: "demo_vend_3", storeName: "Mirpur Fast Food",        storeCategory: "fast-food",   storeDescription: "Burgers, shawarma, broast and more",                storeHours: "11:00-01:00", storeMinOrder: "150",  storeDeliveryTime: "15-25 min", storeAddress: "Allama Iqbal Road, Mirpur",businessType: "restaurant", businessName: "Mirpur Fast Food" },
  { userId: "demo_vend_4", storeName: "Rawalakot Pharmacy",      storeCategory: "pharmacy",    storeDescription: "Medicines, health products and first aid supplies",  storeHours: "09:00-21:00", storeMinOrder: "50",   storeDeliveryTime: "25-40 min", storeAddress: "Main Bazaar, Rawalakot",   businessType: "pharmacy",   businessName: "Rawalakot Pharmacy" },
  { userId: "demo_vend_5", storeName: "Desi Dhaba Chattar",      storeCategory: "restaurant",  storeDescription: "Authentic desi food — nihari, paye, karahi",         storeHours: "06:00-00:00", storeMinOrder: "150",  storeDeliveryTime: "30-45 min", storeAddress: "Chattar, Muzaffarabad",    businessType: "restaurant", businessName: "Desi Dhaba" },
  { userId: "demo_vend_6", storeName: "Mirpur General Store",    storeCategory: "grocery",     storeDescription: "Everything for your home — groceries and essentials", storeHours: "07:00-23:00", storeMinOrder: "100",  storeDeliveryTime: "20-30 min", storeAddress: "Sector F2, Mirpur",        businessType: "grocery",    businessName: "Mirpur General Store" },
];
